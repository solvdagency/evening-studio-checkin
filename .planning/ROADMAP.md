...
- [x] 02-02-PLAN.md — Per-day minutes mapping (D-09) + NSW holiday set → Booking/Absence into Phase 1
...
- [x] 04-03-PLAN.md — Pure mechanical filters + same-day same-client reconciler (TDD; the two golden cases)
...
- [x] 07-01-PLAN.md — Injectable marker/run-log module (idempotency marker + redacted structured log, fully unit-tested) ✅ 2026-06-04
